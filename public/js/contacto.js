...
/*!****************************!*\
  ...
  \****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _toastrConfig_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toastrConfig.js */ "./src/js/toastrConfig.js");
...
class ContactoHandler {
  ...
  async enviarContacto (e) {
    ...
    try {
      ...
      if (res.ok) {
        _toastrConfig_js__WEBPACK_IMPORTED_MODULE_0__["default"].success(data.mensaje)
        e.target.reset()
      } else {
        const mensajes = Array.isArray(data.mensajes) ? data.mensajes : [data.mensajes]
        mensajes.forEach((msg) => _toastrConfig_js__WEBPACK_IMPORTED_MODULE_0__["default"].error(msg))
      }
    } catch (error) {
      _toastrConfig_js__WEBPACK_IMPORTED_MODULE_0__["default"].error('Error al enviar el mensaje. Inténtalo de nuevo más tarde.')
    }
  }
